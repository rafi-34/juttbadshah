...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update JUTT_BADSHAH Tool')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('cd $HOME && git clone https://github.com/jutt125/Badshah')
	    ...
	    psb('Subscrib My Youtube Channel JUTT BADSHAH MASTER✓')
...
def pb():
	...
	print(S+'Process has been completed ok Jutt login ')
